		...
		if i == 0:
			...
			if i == num_levels - 1:
				...
				if SavedData.num_floor == 3:
					...
					if (randi() % 3 == 0 and not special_room_spawned) or (i == num_levels - 2 and not special_room_spawned):
						...
						room = INTERMEDIATE_ROOMS[randi() % INTERMEDIATE_ROOMS.size()].instantiate() # este inyecta habitaciones prefabricadas
			...
			if !is_lateral:
				for y in corridor_height:
					...
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2( - 2, -y + 1), LEFT_WALL_TILE_INDEX)
					...
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2( - 1, -y + 1), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(0, -y + 1), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(1, -y), RIGHT_WALL_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(1, -y + 1), RIGHT_WALL_TILE_INDEX)
			else:
				for x in range(corridor_length):
					# Conexión de habitaciones y pasillos laterales
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(x - 1, 1), TOP_WALL_TILE_ID)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(x - 1, 2), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(x - 1, 3), FLOOR_TILE_INDEX)
					previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(x - 1, 3), BOTTOM_WALL_TILE_ID)

				for y in range(corridor_height):
					# ajuste paredes
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 2, -y + 1), LEFT_WALL_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 2, -y), LEFT_WALL_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length + 1, -y + 1), RIGHT_WALL_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length + 1, -y), RIGHT_WALL_TILE_INDEX)
					# ajuste suelos
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 1, -y + 1), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 1, -y), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length, -y), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length, -y + 1), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 1, -y + 2), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length, -y + 2), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length - 1, -y + 3), FLOOR_TILE_INDEX)
					previous_room_tilemap.set_cell(0,exit_tile_pos + Vector2(corridor_length, -y + 3), FLOOR_TILE_INDEX)

				previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(corridor_length - 2, + 1), TOP_WALL_TILE_ID)
				previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(corridor_length, + 3), BOTTOM_WALL_TILE_ID)
				previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(corridor_length - 1, + 3), BOTTOM_WALL_TILE_ID)
				previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(corridor_length + 1, + 3), RIGHT_WALL_TILE_INDEX)
				previous_room_tilemap2.set_cell(0,exit_tile_pos + Vector2(corridor_length + 1, + 2), RIGHT_WALL_TILE_INDEX)
			...
			if !is_lateral:
				...
				room.position = previous_room_door.global_position + Vector2.UP * room_tilemap.get_used_rect().size.y * TILE_SIZE + Vector2.UP * (1 + corridor_height) * TILE_SIZE + Vector2.LEFT + Vector2(corridor_length, 0) * TILE_SIZE + Vector2.LEFT * room_tilemap.local_to_map(room.get_node("Entrance/Position2D2").position).x * TILE_SIZE
